...
const { editProfile, updateCertificateStatus } = require('../controllers/member.controller');
const upload = multer({ storage: multer.memoryStorage() });
const {protect} = require('../middleware/auth.middleware');
const { getProfile, getItems, getSubmitRequests, getDonorRequests, getCertificates, getAllCounts, getCompletedRequestPercentages, dailyUsers, updateSubmitRequestStatus, updateDonorRequestStatus } = require('../controllers/admin.controller');
...
router.patch('/updateCertificateStatus/:certificateId/:newStatus', protect, updateCertificateStatus);

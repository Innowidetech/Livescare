    ...
    return (
        <div className="flex flex-col items-center py-14">
            <div className="text-start max-w-4xl mx-auto px-4 py-10">
                ...
                <h1 className="text-3xl sm:text-4xl font-bold text-[#FFBA48] mb-4">We'd love to hear from you</h1>
            ...
            <div className="bg-[#FFBA48] w-full py-16">
                    ...
                    <form className="p-8 space-y-6" onSubmit={handleSubmit}>
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                            ...
                            <div className="flex flex-col gap-4">
                                ...
                                <input
                                    ...
                                    className="border-b border-black bg-[#FFBA48] text-lg sm:text-xl"
                                    required
                                />
                        ...
                        <div className="flex flex-col gap-4">
                            ...
                            <textarea
                                ...
                                onChange={handleInputChange}
                                className="p-3 border bg-[#FFBA48] border-black text-lg sm:text-xl"
                                required
                                rows="4"
                            ></textarea>
                        ...
                        <button
                            type="submit"
                            className="bg-[#14213D] text-white py-3 rounded-md text-lg sm:text-lg px-4 hover:bg-orange-600 mx-auto block"
                        >
                            Send Message
                        </button>
                    </form>

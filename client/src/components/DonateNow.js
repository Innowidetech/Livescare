...
const DonateNowForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (selectedItem === ITEM_NAMES.MONEY && paymentMethod === 'Online') {
        ...
        if (response.data) {
          toast.success(response.data.message || 'Donation request submitted successfully!');
          resetForm();
        }
      }
    } catch (error) {
  ...
  return (
    <div>
      ...
      <section className="relative h-screen bg-fill bg-center bg-cover" 
  ...
  <div className="max-w-lg">
    ...
    <p className="text-xl text-center font-semibold bounce delay-2s">
      Your generosity can change lives. By donating today, you provide much-needed support to individuals and communities facing hardship. Every contribution counts!
    </p>
  </div>
</div>
      ...
      <section className="bg-[#F7F7F7] py-16 relative">
        <div className="container mx-auto text-start md:text-center px-4 md:px-0">
          <h2 className="text-4xl font-semibold mt-4 text-center">Choose the Items For Donate</h2>
          ...
          <div className="flex flex-wrap justify-between items-center mt-12 space-y-8 md:space-y-0 md:flex-nowrap">
            ...
            <div className="flex flex-col items-center w-full md:w-1/4 pb-6 md:pb-0 relative mx-2">
              ...
              />
              <p className="text-lg font-semibold text-center">{DISPLAY_NAMES[ITEM_NAMES.FOOD]}</p>
              <p className="text-center text-sm">Delivering nutritious meals to combat hunger and promote health.
              </p>
              <button
            ...
            <div className="flex flex-col items-center w-full md:w-1/4 pb-6 md:pb-0 relative mx-2">
              <img
                ...
                className="w-60 h-32 object-cover rounded-full mb-4"
              />
              <p className="text-lg font-semibold text-center">{DISPLAY_NAMES[ITEM_NAMES.CLOTHES]}</p>
              <p className="text-center text-sm">Offering comfort and dignity with essential apparel.
              </p>
              <button
                className="text-white bg-[#FCA311]  hover:bg-orange-600  px-10 py-2 mt-6 md:mt-10 lg:mt-20 rounded-md shadow-gray-600 shadow-lg"
            ...
            <div className="flex flex-col items-center w-full md:w-1/4 pb-6 md:pb-0 relative mx-2">
              <img
                ...
                className="w-60 h-32 object-cover rounded-full mb-4"
              />
              <p className="text-lg font-semibold text-center">{DISPLAY_NAMES[ITEM_NAMES.EDUCATION]}</p>
              <p className="text-center text-sm">Enriching minds with education for a brighter future.</p>
              <button
                className="text-white bg-[#FCA311]  hover:bg-orange-600   px-10 py-2 mt-6 md:mt-10 lg:mt-20 rounded-md shadow-gray-600 shadow-lg"
            ...
            <div className="flex flex-col items-center w-full md:w-1/4 pb-6 md:pb-0 mx-2">
              <img
                ...
                className="w-60 h-32 object-cover rounded-full mb-4"
              />
              <p className="text-lg font-semibold text-center">{DISPLAY_NAMES[ITEM_NAMES.MEDICAL]}</p>
              <p className="text-center text-sm">Providing crucial healthcare for those in need.
              </p>
              <button
                className="text-white bg-[#FCA311]  hover:bg-orange-600   px-10 py-2 mt-6 md:mt-10 lg:mt-20 rounded-md shadow-gray-600 shadow-lg"
          ...
          <div className="flex flex-wrap justify-between items-center mt-12 space-y-8 md:space-y-0 md:flex-nowrap">
            ...
            <div className="flex flex-col items-center w-full md:w-1/5 pb-6 md:pb-0 relative mx-2">
              <img
                ...
                className="w-60 h-32 object-cover rounded-full mb-4"
              />
              <p className="text-lg font-semibold">{DISPLAY_NAMES[ITEM_NAMES.TOYS]}</p>
              <p className="text-sm text-center">Bringing happiness to children through meaningful play.</p>
              <button
            ...
            <div className="flex flex-col items-center w-full md:w-1/5 pb-6 md:pb-0 relative mx-2">
              <img
                ...
                className="w-60 h-32 object-cover rounded-full mb-4"
              />
              <p className="text-lg font-semibold">{DISPLAY_NAMES[ITEM_NAMES.MONEY]}</p>
              <p className="text-sm text-center">MFunding initiatives to uplift communities.</p>
              <button
                className="text-white bg-[#FCA311]  hover:bg-orange-600   px-10 py-2 mt-10 md:mt-10 lg:mt-20 rounded-md shadow-gray-600 shadow-lg"
            ...
            <div className="flex flex-col items-center w-full md:w-1/5 pb-6 md:pb-0 relative mx-2">
              <img
                src="/Assets/Gamekits.png"
                alt="Games Kit"
                className="w-60 h-32 object-cover rounded-full mb-4"
              />
              <p className="text-lg font-semibold">{DISPLAY_NAMES[ITEM_NAMES.SKILL]}</p>
              <p className="text-sm text-center">Fostering creativity and development through  fun.</p>
              <button
                className="text-white bg-[#FCA311]  hover:bg-orange-600   px-10 py-2 mt-10 md:mt-10 lg:mt-20 rounded-md shadow-gray-600 shadow-lg"
            ...
            <div className="flex flex-col items-center w-full md:w-1/5 pb-6 md:pb-0 mx-2">
              <img
                ...
                className="w-60 h-32 object-cover rounded-full mb-4"
              />
              <p className="text-lg font-semibold">{DISPLAY_NAMES[ITEM_NAMES.OTHER]}</p>
              <p className="text-sm text-center">Supplying vital hygiene and emergency relief items.</p>
              <button
                className="text-white bg-[#FCA311]  hover:bg-orange-600  px-10 py-2 mt-10 md:mt-10 lg:mt-20 rounded-md shadow-gray-600 shadow-lg"
          ...
          {isFormVisible && (
            <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-20 overflow-hidden">
              <div className="bg-white rounded-lg shadow-lg w-3/4 sm:w-1/2 lg:w-2/5 relative max-h-[85vh] flex flex-col mt-20">
                <h2 className="text-2xl font-semibold p-6 border-b">Donate for {DISPLAY_NAMES[selectedItem]}</h2>
                
                {/* Form content with scroll */}
                <div className="overflow-y-auto p-6 flex-grow">
                  <form className="flex flex-col space-y-4" onSubmit={handleSubmit}>
                    <div className="mb-4">
                      <label htmlFor="donor-name" className="block text-lg text-left">Donor Name</label>
                      <input
                        type="text"
                        id="donor-name"
                    ...
                    {selectedItem === ITEM_NAMES.MONEY ? (
                      <>
                        ...
                        <div className="mb-4">
                          <label htmlFor="payment-method" className="block text-lg text-left">Payment Method</label>
                          <select
                            id="payment-method"
                            className="w-full p-2 border border-gray-300 rounded"
                            value={paymentMethod}
                    ...
                    <div className="mb-4">
                      ...
                      <input
                        ...
                        required
                      />
                      <small className="text-gray-500">Please enter a valid phone number (e.g., +1234567890)</small>
                    </div>
                    ...
                    <div className="mb-4">
                      ...
                      <input
                        ...
                        required
                      />
                      <small className="text-gray-500">Please enter a valid 6-digit pincode</small>
                    </div>
                  ...
                  <div className="text-center">
                    ...
                    >
                      {loading ? (
                        ...
                        selectedItem === ITEM_NAMES.MONEY ? 'Proceed to Payment' : 'Submit'
                      )}
                    </button>
                  </div>
                </div>

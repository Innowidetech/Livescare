  ...
  if (isDate) {
    return (
      <div className="relative" ref={dropdownRef}>
        <div className="flex items-center p-2 gap-2 md:gap-2 md:px-4 md:py-2 text-[#808080] border border-[#E5E5E5] rounded-lg text-xs md:text-lg calendar">
          <DatePicker
            selected={value}
            onChange={onChange}
...
function SubmitRequestHistory() {
  ...
  return (
    <>
      ...
      <ToastContainer
        ...
        theme="light"
      />
      <div className="min-h-screen p-4 md:mt-12">
  ...
  <div className="flex flex-col gap-6">
    <div className="flex flex-col sm:flex-row justify-between items-center sm:items-start">
      ...
      <h1 className="text-xl sm:text-2xl font-medium text-[#202224] text-center" style={{fontFamily:'Inter'}}>
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b bg-[#F1F4F9]" style={{fontFamily:'Inter'}}>
                    ...
                    <th className="px-4 py-4 text-left font-medium text-[#202224]">Description
                    </th>
                    <th className="px-4 py-4 text-left font-medium text-[#202224]">
                      Status
                    </th>
                ...
                <tbody>
                  {filteredRequests.filter((item) => item.status == "Completed" ).map((item) => (
                    <tr key={item.id} className="border-b last:border-b-0">
                      <td className="px-4 py-4 text-[#202224]">{item.name}</td>

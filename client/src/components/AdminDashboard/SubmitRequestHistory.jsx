...
import { fetchSubmitRequests, setSelectedView, updateRequestStatus } from '../../redux/submitSlice';
                ...
                >
                  <div className="space-y-2">
                    <div className="grid">
                      ...
                      <div className="flex items-center justify-between">
                        <h1 className="text-left font-medium text-[#202224]">
                        </h1>
                        <button
                          onClick={() => handleOpenModal(item.description)}
...
export default SubmitRequestHistory;
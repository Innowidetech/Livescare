...
} from "../../redux/member/memberSubmitSlice";
import {
  MapPin,
  Phone,
  Mail,
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-xl p-6 max-w-lg w-full mx-4">
        <div className="flex justify-between items-center mb-4">
          <h3 className="text-lg md:text-xl font-medium text-[#14213D]">
            Description
          </h3>
          <button
            onClick={onClose}
...
function MemberSubmitrequest() {
  const dispatch = useDispatch();
  const { requests, status, error, selectedView } = useSelector((state) => state.memberSubmit);
    ...
    if (requests?.submits) {
      ...
      if (selectedItemType && selectedItemType !== "All") {
        filtered = filtered.filter(
          (item) => item.itemName === selectedItemType
        );
      }
  ...
  }, [requests?.submits, selectedDate, selectedItemType]);
                ...
                >
                  <div className="space-y-2">
                    <div className="grid">
                      ...
                      <div className="flex items-center justify-between">
                        <h1 className="text-left font-medium text-[#202224] text-sm"></h1>
                        <button
                          onClick={() => handleOpenModal(item.description)}
...
export default MemberSubmitrequest;
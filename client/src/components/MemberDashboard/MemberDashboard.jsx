...
const MemberDashboard = () => {
  ...
  return (
    <>
      <div className="p-4 sm:p-6 mt-10 md:mt-12">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-center">
              <div className="flex flex-col items-start mb-6 sm:mb-0 sm:w-1/2 gap-3">
                ...
                <div className="flex items-center mb-4 sm:mb-0">
                  ...
                  <div className="text-lg font-normalsm:text-xl text-[#1e1e1e]" style={{fontFamily:'Inter'}}>
            ...
            <div className="text-lg font-medium sm:text-xl w-full sm:w-auto text-[#1e1e1e]" style={{fontFamily:'Inter'}}>Submit Requests</div>
              ...
              <div className="flex items-center bg-[#fcfdfd] border border-[#d5d5d5] rounded-md px-3 py-2 sm:px-4 sm:py-3 w-full sm:w-auto justify-between mt-2 sm:mt-0">
                <DatePicker
                  ...
                  dateFormat="MMMM yyyy"
                  showMonthYearPicker
                  className="bg-transparent text-[#1e1e1e] text-xs sm:text-sm md:text-base cursor-pointer"
                />
              </div>
            </div>
            <hr className="border-t-2 border-gray-200 mb-4" />

...
import { FaHistory } from "react-icons/fa"; 
  import { 
    ...
    fetchMemberDashboardPercentages,
    fetchMemberDailyUsers,
    setTimePeriod,
    setSelectedDate 
  } from '../../redux/member/memberdashboard';

ChartJS.register(ArcElement, Tooltip, Legend);

const MemberDashboard = () => {
  const dispatch = useDispatch();
  const { stats, percentages, loading, error } = useSelector((state) => state.memberDashboard);
  const { 
    currentPeriod, 
    previousPeriod, 
    timePeriod, 
  ...
  useEffect(() => {
    dispatch(fetchMemberDashboardStats());
    dispatch(fetchMemberDashboardPercentages({
  ...
  return (
    <>
      ...
      <div className="p-4 sm:p-6">
        <h2 className="text-3xl font-semibold mb-6 text-center sm:text-left">Dashboard</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 py-4">
          <div className="bg-white text-black p-6 shadow-lg rounded-lg flex justify-between items-center">
            <div>
              <h3 className="text-sm font-normal">Total Items</h3>
          ...
          <div className="bg-white text-black p-6 shadow-lg rounded-lg flex justify-between items-center">
            <div>
              <h3 className="text-sm font-normal">Submit Requests</h3>
              <p className="text-2xl font-bold">{stats.submitRequestsCount}</p>
            </div>
          ...
          <div className="bg-white text-black p-6 shadow-lg rounded-lg flex justify-between items-center">
            <div>
              <h3 className="text-sm font-normal">Donar Requests</h3>
              <p className="text-2xl font-bold">{stats.donorRequestsCount}</p>
            </div>
          ...
          <div className="bg-white text-black p-6 shadow-lg rounded-lg flex justify-between items-center">
            <div>
              <h3 className="text-sm font-normal">Dispatched</h3>
              <p className="text-2xl font-bold">{stats.dispatchedCount}</p>
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 mt-6">
          <div className="bg-white p-4 sm:p-6 shadow-lg rounded-lg border border-gray-300">
            <div className="flex justify-between mb-4 flex-wrap">
              <div className="text-lg font-bold sm:text-xl w-full sm:w-auto">Donor Requests</div>
              <div className="flex items-center bg-gray-100 border border-gray-300 rounded-md px-3 py-2 sm:px-4 sm:py-3 w-full sm:w-auto justify-between mt-2 sm:mt-0">
                <DatePicker
                  selected={selectedDate}
                  onChange={handleDateChange}
                  dateFormat="MMMM yyyy"
                  showMonthYearPicker
                  className="bg-transparent text-gray-600 text-xs sm:text-sm md:text-base cursor-pointer"
                />
              </div>
            </div>
          ...
          <div className="bg-white p-4 sm:p-6 shadow-lg rounded-lg border border-gray-300">
            <div className="flex justify-between mb-4 flex-wrap">
              <div className="text-lg font-bold sm:text-xl w-full sm:w-auto">Submit Requests</div>
              <div className="flex items-center bg-gray-100 border border-gray-300 rounded-md px-3 py-2 sm:px-4 sm:py-3 w-full sm:w-auto justify-between mt-2 sm:mt-0">
                <DatePicker
                  selected={selectedDate}
                  onChange={handleDateChange}
        ...
        <div className="bg-white p-6 shadow-lg rounded-lg border border-gray-300 mt-6">
          <div className="flex flex-wrap justify-between items-center mb-4">
            <div className="text-xl font-bold mb-2 sm:mb-0">Daily Users</div>
          ...
          {isDropdownOpen && (
            <div className="bg-white border border-gray-300 rounded-md shadow-md p-2 w-24 absolute mt-2 z-50 right-6">
              <ul>
                <li 

    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-xl p-6 max-w-lg w-full mx-4">
        <div className="flex justify-between items-center mb-4">
          <h3
            className="text-lg md:text-xl font-medium text-[#14213D]"
...
function MemberDonorRequest() {
  const dispatch = useDispatch();
  const { donors, status, error, selectedView } = useSelector(
    (state) => state.memberDonor
  );
                  ...
                  <tr className="border-b bg-[#F1F4F9]">
                    ...
                    <th className="px-6 py-4 text-left font-medium text-[#202224]">
                      <DropdownMenu
                        ...
                        value={
                          selectedView.place.charAt(0).toUpperCase() +
                          selectedView.place.slice(1)
                        }
...
export default MemberDonorRequest;

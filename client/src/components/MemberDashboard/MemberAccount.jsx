    ...
    <>
      <div className="bg-white p-6 shadow-lg rounded-lg border border-gray-300 mt-6 w-full mx-auto">
        <div className="flex flex-wrap justify-between items-center mb-4">
          <div className="text-xl font-bold mb-2 sm:mb-0">Total Donor Income</div>
      ...
      <div className="mt-8 grid lg:grid-cols-2 gap-8">
        ...
        <div className="bg-white p-6 rounded-lg shadow-lg">
          <div className="flex justify-between items-center mb-6">
            <h3 className="text-xl font-medium">Inflow invoices</h3>
          </div>
          <div className="flex items-start justify-between">
            ...
            <div className='grid p-4'>
              ...
              <div className='grid md:grid-cols-2 lg:grid-cols-3 gap-3 flex-grow ml-8'>
        ...
        <div className="bg-white p-6 rounded-lg shadow-lg">
          <div className="flex justify-between items-center mb-6">
            <h3 className="text-xl font-medium">Outflow invoices</h3>
          </div>
          <div className="flex items-start justify-between">
            <div className="relative w-48 h-48">
              <svg

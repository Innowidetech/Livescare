...
/>
          ...
          <p className="text-gray-400">
            We are a dynamic company committed to delivering exceptional service. Our team values creativity and innovation, and we strive to build lasting relationships with our clients and partners.
          </p>
        </div>

        {/* Column 2 (Home Section) */}
        <div className="ml-0 sm:ml-8"> {/* Add margin-left here for larger screens */}
  ...
  <ul className="space-y-3"> {/* Added space between list items */}
    ...
    <li><Link to="/donatenow" className="text-gray-400 hover:text-white">Donate</Link></li>
    <li><Link to="/Contact" className="text-gray-400 hover:text-white">Contact Us</Link></li>
        ...
        <div>
          ...
          <ul className='space-y-3'>
            ...
            <li><a href="/LinkdIn" className="text-gray-400 hover:text-white">LinkedIn</a></li>
          </ul>
        </div>
  ...
  <div className="mt-8">
    ...
    <div className="flex items-center ">
      <input
        ...
        className="p-2  text-gray-800 bg-[#14213D] focus:outline-none border border-white"

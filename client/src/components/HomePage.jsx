...
const DonutChart = ({ donationData = [] }) => {
  ...
  const colors = [
    ...
    "#FF6B6B",
    "#4ECDC4",
    "#45B7D1", // Added more colors for additional categories
  ];
...
const HomePage = () => {
  ...
  const { donationData = [], loading: donationLoading } = useSelector(
  ...
  const images = [
    {
      ...
      description:
        "Target: ₹2,00,000 | Every contribution ensures meals for those in need.",
      location: "Mumbai",
    },
    {
      src: Meals,
      ...
      description:
        "Target: ₹2,00,000 | Support us in providing nourishment for elderly.",
      location: "Bihar",
    },
    {
      src: Education,
      ...
      description:
        "Target: ₹2,00,000 | Help us provide learning resources for children.",
      location: "Pune",
    },
    {
      src: Medical,
      ...
      description:
        "Target: ₹2,00,000 | Contribute to essential healthcare services treatments.",
      location: "Hyderabad",
    },
  ];
  ...
  return (
    <div>
      ...
      <section
        ...
        style={{ backgroundImage: "url(/HomeChil.avif)" }}
      >
              ...
              <div className="flex flex-col sm:flex-row items-center justify-between">
                ...
                <div className="w-full sm:w-1/2 text-lg sm:text-left px-6 sm:px-0">
                  <ul className="list-disc list-inside">
                    <li className="mb-2">
                      Delivering wholesome meals to individuals and families
                      facing food insecurity.
                    </li>
                    <li className="mb-2">
                      Implementing long-term solutions to combat hunger and
                      malnutrition.
                    </li>
                    <li className="mb-2">
                      Improving health and well-being through accessible,
                      nutritious food.
                    </li>
                  </ul>
                </div>
            ...
            {selectedSection === "medicalFacilities" && (
              <div className="flex flex-col sm:flex-row items-center justify-between">
                ...
                <div className="w-full sm:w-1/2 text-lg sm:text-left px-6 sm:px-0">
                  <ul className="list-disc list-inside">
                    <li className="mb-2">
                      Offering free check-ups, treatments, and medications to
                      those in need.
                    </li>
                    <li className="mb-2">
                      Educating communities on preventive care and wellness.
                    </li>
                    <li className="mb-2">
                      Providing immediate medical support during crises.
                    </li>
                  </ul>
                </div>
              </div>
            ...
            {selectedSection === "educationFacilities" && (
              <div className="flex flex-col sm:flex-row items-center justify-between">
                ...
                <div className="w-full sm:w-1/2 text-lg sm:text-left px-6 sm:px-0">
                  <ul className="list-disc list-inside">
                    <li className="mb-2">
                      Effortlessly support our causes with user-friendly
                      donation options.
                    </li>
                    <li className="mb-2">
                      Easily keep track of your contributions and impact.
                    </li>
                    <li className="mb-2">
                      Opt for one-time or monthly donations to support our
                      initiatives.
                    </li>
                  </ul>
                </div>
        ...
        <div className="container mx-auto text-center">
          ...
          <div className="flex flex-col md:flex-row justify-center items-center space-y-8 md:space-y-0 md:space-x-6">
            ...
            <div className="relative w-full max-w-[260px] h-[265px] border-2 border-black p-6 transform transition-all duration-300 hover:scale-105 hover:shadow-lg">
              ...
              <p className="text-gray-700 md:text-xs lg:text-lg break-words">
                Share your requirements with us, and we'll evaluate how we can
                help.
              </p>
            </div>
            ...
            <div className="relative flex items-center justify-center">
              <span className="text-black text-2xl md:rotate-0 rotate-90">
                ➔
              </span>
            </div>
            ...
            <div className="relative w-full max-w-[260px] h-[265px] border-2 border-black p-6 transform transition-all duration-300 hover:scale-105 hover:shadow-lg">
              ...
              <p className="text-gray-700 md:text-xs lg:text-lg break-words">
                Stay updated on the progress of requests and pending needs.
              </p>
            </div>
            ...
            <div className="relative w-full max-w-[260px] h-[265px] border-2 border-black p-6 transform transition-all duration-300 hover:scale-105 hover:shadow-lg">
              ...
              <p className="text-gray-700 md:text-xs lg:text-lg break-words">
                Check the availability of resources and supplies to address
                ongoing needs.
              </p>
            </div>
            ...
            <div className="relative w-full max-w-[260px] h-[265px] border-2 border-black p-6 transform transition-all duration-300 hover:scale-105 hover:shadow-lg">
              ...
              <p className="text-gray-700 md:text-xs lg:text-lg break-words">
                Contribute to our mission and bring hope to countless lives.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="bg-[#F7F7F7] py-16">
        <div className=" mx-auto text-center px-4 md:px-0">
          ...
          <h2 className="text-4xl font-semibold mt-4">
            We believe that together, we can eliminate
          </h2>
          <h2 className="text-4xl font-semibold mt-2">
            <span className="text-[#FCA311]">Poverty</span> and create a better
            future.
          </h2>
          ...
          <div className="flex flex-wrap justify-between items-center mt-12 space-y-8 md:space-y-0 md:flex-nowrap">
            ...
            <div className="flex flex-col items-center w-full md:w-1/5 pb-6 md:pb-0 relative mx-2">
              ...
              <p> Offering comfort and dignity with essential apparel.</p>
            </div>
            ...
            <div className="flex flex-col items-center w-full md:w-1/5 pb-6 md:pb-0 relative mx-2">
              ...
              <p>Enriching minds with education for a brighter future.</p>
            </div>
            ...
            <div className="flex flex-col items-center w-full md:w-1/5 pb-6 md:pb-0 mx-2">
              ...
              <p> Providing crucial healthcare for those in need.</p>
            </div>
          </div>
          ...
          <div className="flex flex-wrap justify-between items-center mt-12 space-y-8 md:space-y-0 md:flex-nowrap">
            ...
            <div className="flex flex-col items-center w-full md:w-1/5 pb-6 md:pb-0 relative mx-2">
              ...
              <p>Bringing happiness to children through meaningful play.</p>
            </div>
            ...
            <div className="flex flex-col items-center w-full md:w-1/5 pb-6 md:pb-0 relative mx-2">
              ...
              <p>Funding initiatives to uplift communities.</p>
            </div>
            ...
            <div className="flex flex-col items-center w-full md:w-1/5 pb-6 md:pb-0 relative mx-2">
              ...
              <p>
                {" "}
                Fostering creativity and development through interactive fun.
              </p>
            </div>
            ...
            <div className="flex flex-col items-center w-full md:w-1/5 pb-6 md:pb-0 mx-2">
              <img
                ...
                className="w-60 h-32 object-cover rounded-full mb-4"
              />
              <p className="text-lg font-semibold">Other Essentials</p>
              <p>Supplying vital hygiene and emergency relief items.</p>
            </div>
          </div>
          <Link to="/DonateNow">
    ...
    <div className="flex flex-col md:flex-row justify-between items-center mt-6 md:mt-0">
        ...
        <div className="flex flex-col md:flex-row px-6 md:mx-8 justify-between items-center">
          <div className="w-full md:w-2/3 text-left mb-6 md:mb-0">
            ...
            <p className="text-base mb-6 text-center md:text-left">
              Your trust is invaluable to us. Here's how we allocate your
            ...
            {donationLoading ? (
              ...
              <ul className="flex flex-wrap gap-4">
                {donationData.map((item, index) => (
                  <li
                    key={index}
                    className="w-full sm:w-1/2 lg:w-1/3 flex items-center mb-4"
                  >
                    <div
                      className="w-4 h-4 rounded-full"
                      style={{
      ...
      <section className="bg-[#F7F7F7] py-16">
        <div className="container mx-auto text-center px-6 md:px-0 relative">
          <h2 className="text-3xl font-bold sm:text-xl lg:text-4xl">
            You Can Contribute!
          </h2>
          <p className="mt-4 text-base sm:text-sm md:text-lg">
            We can make a meaningful impact in the lives of those who are less
            fortunate.
          </p>
          <p className="mt-2 text-base sm:text-sm md:text-lg">
            Together, we can work towards a world where everyone has access to
            the resources
          </p>
          <p className="mt-2 text-base sm:text-sm md:text-lg">
            they need to thrive.
          ...
          >
            {images.map((img, index) => (
              <div key={index} className="relative px-6">
                ...
                <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-[220px] md:w-7/11 lg:w-2/3 bg-white text-black text-center py-4 px-6 z-10 lg:h-40">
                  ...
                  {/* Text Content */}
                  <p className="text-xs sm:text-sm md:text-xs lg:text-base text-left mt-6 font-bold w-[200px] md:w-auto">
                    {img.title}
                  </p>
                  <p className="text-xs sm:text-sm md:text-xs lg:text-sm text-left w-[200px] md:w-auto">
                    {img.description}
                  </p>
      ...
      <section className="py-16 bg-[#F7F7F7]">
        ...
        <div className="flex flex-wrap justify-center md:mx-10 items-center gap-6 mt-8 px-6 md:px-0">
          {loading ? (
            ...
            programs.map((program) => (
              <div
                key={program._id}
                className="flex flex-col items-center  bg-[#FFBA48] text-black py-4 px-6 rounded-lg w-full sm:w-[400px] h-[150px] mx-2"
              >
                <div className="flex justify-between w-full items-center">
                  <div className="flex flex-col items-center">
                    ...
                    <span className="text-xl">
                      {new Date(program.date).toLocaleString("default", {
                        month: "short",
                      })}
                    </span>
                  </div>
